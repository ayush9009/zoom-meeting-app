...
import { useEuiTheme, getSecureRelForTarget, isColorDark, wcagContrastMin } from '../../services';
    ...
    try {
      ...
      if (COLORS.includes(color)) {
        ...
        switch (color) {
          case 'hollow':
            return style;
          // hollow uses its own Emotion class
          case 'default':
            colorHex = euiTheme.euiTheme.colors.lightShade;
            break;
          default:
            colorHex = euiButtonFillColor(euiTheme, color).backgroundColor;
            break;
        }
